...
{name: 'ΒΕΡΓΙΝΑ',lat: 41.0738353, log: 25.492092, icon: 'peristeri.png'},
...
{name: 'ΟΛΥΜΠΟΣ',lat: 40.2786946, log: 22.5163753, icon: 'olymposbeer.png'},
{name: 'ΔΙΩΝΗ-ΟΡΑ',lat: 38.1751188, log: 21.6814406, icon: 'patraiki.png'},
{name: 'ΣΤΑΛΛΑ ΡΟΥΣΣΑ',lat: 39.2579464, log: 20.9818888, icon: 'stala.png'},
{name: 'ΣΤΙΛΒΗ',lat: 39.1579464, log: 20.9818888, icon: 'stilvi.png'},
...
{name: 'ΛΥΡΑ LIRA',lat: 35.4954916, log: 23.6545257, icon: 'lyra.png'},
{name: 'OLYMPICA MAGNA',lat: 37.7093679, log: 21.5595479, icon: 'magna.png'},
{name: 'JOHNNIES BEER',lat: 41.089483, log: 24.224047, icon: ''},
{name: 'ΛΗΘΕΝΙΑ LITHENIA',lat: 39.5467904, log: 21.7739378, icon: ''},
{name: '56',lat: 37.11064, log: 25.24349, icon: ''},
{name: 'ΘΕΡΟΣ THEROS',lat: 41.112538, log: 24.87042, icon: ''},
